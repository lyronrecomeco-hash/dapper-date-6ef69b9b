...
const ZIP_URL = "https://vikabbqyfduibrykikvx.supabase.co/storage/v1/object/public/public-assets/barbearia-source.zip?v=20260408-php";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "hsl(230 20% 5%)" }}>
      <div className="glass-card-strong p-8 max-w-md w-full text-center space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground mb-2">Clone PHP do projeto</h1>
          <p className="text-sm text-muted-foreground">Este ZIP contém a versão PHP/HTML/CSS deste app, com o mesmo layout, modais, menu, admin, login e integração com o banco da Lovable Cloud.</p>
        </div>
        ...
        <div className="space-y-2 text-left p-4 rounded-xl" style={{ background: "hsl(0 0% 100% / 0.03)", border: "1px solid hsl(0 0% 100% / 0.06)" }}>
          ...
          {[
             "Página principal com serviços e loja",
             "Mesmo layout glassmorphism e cores",
             "Sistema de agendamento completo",
             "Painel admin com login seguro",
             "Serviços, barbeiros, cupons e pedidos",
             "Loja, roleta premiada e configurações",
             "Código PHP + HTML + CSS puro",
             "Mesma integração com Lovable Cloud",
             "Roda com php -S localhost:8000",
          ].map((item) => (
        ...
        <a href={ZIP_URL}
          ...
          <Download className="w-5 h-5" /> Baixar Projeto PHP (.zip)
        </a>
