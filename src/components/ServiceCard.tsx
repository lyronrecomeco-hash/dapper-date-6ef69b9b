      ...
      <div className="flex items-stretch">
        ...
        <div className="flex-1 min-w-0 p-3 min-[375px]:p-4 sm:p-5 flex flex-col justify-center">
          ...
          <div className="flex items-center justify-between mt-2 min-[375px]:mt-3 gap-2">
            ...
            <button className="flex items-center justify-center gap-1.5 px-4 py-2 min-[375px]:px-5 min-[375px]:py-2.5 text-[11px] min-[375px]:text-xs sm:text-sm whitespace-nowrap rounded-xl w-full sm:w-auto font-semibold transition-all duration-300" style={{ background: 'hsl(0 0% 12%)', color: 'hsl(0 0% 65%)', border: '1px solid hsl(0 0% 18%)' }}>
